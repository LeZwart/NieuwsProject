        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div>
                        <div class="flex justify-center space-x-8 mt-4 bg-slate-200 p-3 w-min mx-auto">
                            <x-dashboard-button href="{{ route('news.create') }}">Maak een post</x-dashboard-button>
                            <x-dashboard-button href="{{ route('news.index') }}">Bekijk het nieuws</x-dashboard-button>
                        </div>
                        <div class="flex justify-center space-x-8 mt-4 bg-slate-200 p-3 w-min mx-auto">
                        ...
                        <div class="flex justify-center space-x-8 mt-4 bg-slate-200 p-3 w-min mx-auto">
                            <x-dashboard-button href="{{ route('stats') }}">Statistieken</x-dashboard-button>
                        </div>
                    </div>
                </div>
            </div>
